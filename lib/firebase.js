...
export const addComment = async (comment) => {
  try {
    const commentsCollectionRef = collection(database, "comments"); // Specify the collection path ("comments" in this example)
    await addDoc(commentsCollectionRef, comment); // Add the comment document to the "comments" collection
