            ...
            <div className="text-center max-w-sm min-h-44 mx-auto py-16">
                ...
                >
                    ...
                    <p className="text-gray-400">
                        ...
                        <span className="text-gray-500 font-semibold cursor-pointer"><Translate>click to browse</Translate></span>
                    </p>
                </div>
                <p className="text-gray-400 mt-2"><Translate>Attach an image</Translate></p>
                <aside>
                    {files.length > 0 && (
                        <>
                            <h4>Files</h4>
